...
def classify_boundary_point(
    ...
    local-channel-valid: local channel advantage exists and the diagnostic QZZB floor does not materially raise the lower bound.
    """
    ...
    if guard_ratio <= local_ratio_tolerance:
        return "local-channel-valid"
    return "guarded"


CLASS_TO_INT = {"local-channel-valid": 0, "guarded": 1, "stop-extrapolation": 2}
